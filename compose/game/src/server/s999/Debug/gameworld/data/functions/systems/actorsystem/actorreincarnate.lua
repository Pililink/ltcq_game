...
function addExp(actor, val)
	...
	updateInfo(actor)
	System.logCounter(LActor.getActorId(actor), LActor.getAccountName(actor), tostring(LActor.getLevel(actor)),"get lunhui exp", tostring(val), tostring(actordata.reincarnate_exp), "", "", "", "")
end
