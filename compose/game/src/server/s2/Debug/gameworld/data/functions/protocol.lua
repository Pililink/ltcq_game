...
Protocol = {
	...
	CMD_DailyRedPacket = 78, -- 每日红包
	CMD_DemonCircle = 79, -- 法阵系统
	CMD_DominateEquip = 80, -- 主宰装备
	CMD_ChuanShi = 81, --传世神器

	CMD_ForbiddenArea = 82, -- 神器禁地

	CMD_PlayerReturn = 83, -- 老玩家回归
	...
	sFubenCmd_EvilRoomInfo = 43,	-- 恶魔殿副本返回数据
	sFubenCmd_EvilRoomChallenge = 44,	-- 恶魔殿副本挑战
	...
	cFubenCmd_EvilRoomInfo = 43, -- 恶魔殿副本请求数据
	cFubenCmd_EvilRoomChallenge = 44, -- 恶魔殿副本挑战
	...
	sEquipCmd_ReqLeiTingLevelUpRep = 9, -- 雷霆装备淬炼反馈
	sEquipCmd_ReqLeiTingTaozhuangLevelUp = 10, -- 雷霆套装激活和升级反馈
	sEquipCmd_ShengZhuangDebrisExchange = 11, -- 神装碎片兑
	sEquipCmd_ShengZhuangDebrisExchangeInfo = 12, -- 神装碎片兑换次数信息

	-- 暗殿装备
	sEquipCmd_DarkhallItemIdInfo = 13, -- 暗殿部位道具id
	sEquipCmd_DarkhallLv = 15, -- 暗殿部位强化等级
	sEquipCmd_DarkhallStoneInfo = 16, -- 暗殿石头
	sEquipCmd_DarkhallEquipSmelt = 18, -- 装备熔炼信息
	sEquipCmd_DarkhallLingPower = 19,-- 灵力信息
	sEquipCmd_DarkhallStrengthExp = 20,-- 强化经验
	sEquipCmd_DarkhallRoleInfo = 22, -- 角色暗殿装备等信息

	sEquipCmd_EquipSmeltBroadCast = 23, -- 熔炼元宝公告
	sEquipCmd_EquipSmeltDoubleTime = 24, -- 熔炼双倍时间和今日熔炼数量
	sEquipCmd_EquipSmeltOneBroadCast = 25, -- 最新一条熔炼元宝公告
	...
	cEquipCmd_ReqLeiTingLevelUpReq = 9, -- 雷霆装备淬炼请求
	cEquipCmd_ReqLeiTingTaozhuangLevelUp = 10, --  雷霆套装激活和升级请求
	cEquipCmd_ShengZhuangDebrisExchange = 11, -- 神装碎片兑换
	cEquipCmd_ShengZhuangDebrisExchangeInfo = 12, -- 神装碎片兑换次数信息

	--暗殿装备
	cEquipCmd_DarkhallEquipChange = 13, -- 暗殿装备更换(包括装备和更换)
	cEquipCmd_DarkhallEquipTakeOff = 14, -- 暗殿装备卸下
	cEquipCmd_DarkhallEquipStrengthen = 15, -- 暗殿装备强化
	cEquipCmd_DarkhallEquipStoneLvUp = 16, -- 石头升级
	cEquipCmd_DarkhallEquipExchange = 17, -- 暗殿装备升阶(身上装备兑换)
	cEquipCmd_DarkhallEquipSmelt = 18, -- 暗殿装备熔炼
	cEquipCmd_EquipSmeltBroadCast = 23, -- 熔炼元宝公告请求
	cEquipCmd_EquipSmeltDoubleTime = 24, -- 熔炼双倍时间和今日熔炼数量
	...
	sHideBoss_Info = 38,
	sMultipleBoss_Info = 39, -- 单副本多boss时推送的协议
	...
	sPActivityCmd_SendReawardData = 12, -- 下发豪华连冲信息

	cPActivityCmd_GetActivityData = 7, -- 请求单个活动数据
	cPActivityCmd_GetRewardRequest = 2, -- 请求单个活动奖励
	cPActivityCmd_ReqBuyFund = 11,	-- 请求购买成长基金
	cPActivityCmd_getReaward = 12, -- 请求领取豪华连冲奖励
	...
	cRechargeCmd_LimitBuy = 13, -- 请求限购信息
	...
	sTwGift_Info = 2,
	sTwGift_Get = 3,
	sFangpian_AwardInfo = 4, -- 服务器下发防骗奖励信息
	sFangpian_AwardRep = 5, -- 领取响应

	cGiftCodeCmd_GetGift = 1,
	cTwGift_Info = 2,
	cTwGift_Get = 3,
	cFangpian_AwardReq = 5, -- 客户端请求领取奖励
	...
	sChatCmd_ChatMsgDelGM = 6, -- GM删除聊天记录
	...
	sGuildCmd_GuildGather = 32, -- 工会召集
	sGuildCmd_GuildChatMsgDelGM = 33, -- 删除工会玩家记录
	-- TitleCmd
	...
	sTitleCmd_Del = 3,
	sTitleCmd_Update = 4,
	sTitleCmd_LevelUp = 5, -- 称号升级s

	cTitleCmd_Info = 1,
	cTitleCmd_SetTitle = 4,
	cTitleCmd_LevelUp = 5, -- 称号升级c
	...
	sGuildBattleCmd_GetRoleCount		  = 35,
	...
	cGuildBattleCmd_GetRoleCount		  = 35,
	...
	sChuanShiCmd_SendInfo = 1, --登陆下发数据
	sChuanShiCmd_SendChuanShiLvInfo = 2, --传世等级信息
	sChuanShiCmd_SendChuanShiStarLvInfo = 3, --传世星级信息

	cChuanShiCmd_ReqChuanShiLvInfo = 2, --请求强化等级
	cChuanShiCmd_ReqChuanShiStarLvInfo = 3, --请求激活神器/神器升星
	...
	cPeakRace_ShowSignup = 15, -- 请求报名清单
	...
	sPeakRace_ShowSignup = 15, -- 反馈报名清单
	...
	sCrossBossCmd_SendBossInfo = 1, -- 跨服BOSS信息
	...
	sCrossBossCmd_SendEliteBossInfo = 21, -- 跨服精英BOSS信息
	sCrossBossCmd_belongEliteUpdate = 22, -- 下发精英BOSS的归属者信息
	sCrossBossCmd_ResurgenceEliteInfo = 23, -- 玩家复活
	sCrossBossCmd_BossEliteResurgence = 25, -- boss复活
	sCrossBossCmd_SendEliteActorInfo = 29, -- 玩家在精英BOSS的个人信息
	sCrossBossCmd_SendEliteRewardInfo = 30, -- 精英BOSS弹框奖励
	sCrossBossCmd_ReqEliteShowInfo = 31, -- 不用
	sCrossBossCmd_SendEliteWinInfo = 32, -- 不用
	sCrossBossCmd_EliteBossShield = 33, -- 精英BOSS护盾信息
	sCrossBossCmd_EliteBossResurgenceTime = 34, -- boss剩余复活时间

	sCrossBossCmd_SendDarkhallBossInfo = 41, -- 暗殿BOSS信息
	sCrossBossCmd_ResurgenceDarkhallInfo = 43, -- 玩家复活
	sCrossBossCmd_BossDarkhallResurgence = 45, -- boss复活
	sCrossBossCmd_belongDarkhallUpdate = 46, -- 下发精英BOSS的归属者信息
	sCrossBossCmd_DarkhallBossTips = 48, -- boss提醒数据
	sCrossBossCmd_SendDarkhallActorInfo = 49, -- 玩家在精英BOSS的个人信息
	sCrossBossCmd_SendDarkhallRewardInfo = 50, -- 精英BOSS弹框奖励
	sCrossBossCmd_DarkBossShield = 53, -- 暗殿BOSS护盾信息
	
	sCrossBossCmd_SendZhuzaiBossInfo = 61, -- 主宰BOSS信息
	sCrossBossCmd_ResurgenceZhuzaiInfo = 63, -- 玩家复活
	sCrossBossCmd_BossZhuzaiResurgence = 65, -- boss复活
	sCrossBossCmd_belongZhuzaiUpdate = 66, -- 下发精英BOSS的归属者信息
	sCrossBossCmd_ZhuzaiBossTips = 68, -- boss提醒数据
	sCrossBossCmd_SendZhuzaiActorInfo = 69, -- 玩家在精英BOSS的个人信息
	sCrossBossCmd_SendZhuzaiRewardInfo = 70, -- 精英BOSS弹框奖励
	sCrossBossCmd_ZhuzaiBossShield = 73, -- 主宰BOSS护盾信息
	...
	cCrossBossCmd_ReqEliteBossInfo = 21, -- 跨服精英BOSS
	cCrossBossCmd_BuyEliteCd = 23,
	cCrossBossCmd_CancelEliteBelong = 24, -- 取消归属
	cCrossBossCmd_RequestEliteEnter = 26,
	cCrossBossCmd_RequestEliteCollect = 28,
	cCrossBossCmd_ReqEliteShowInfo = 31,

	cCrossBossCmd_ReqDarkhallBossInfo = 41, -- 请求暗殿BOSS信息
	cCrossBossCmd_RequestDarkhallEnter = 42, -- 请求进入挑战暗殿BOSS
	cCrossBossCmd_BuyDarkhallCd = 43, -- 购买复活CD
	cCrossBossCmd_CancelDarkhallBelong = 44, -- 取消boss归属
	cCrossBossCmd_BuyBelongCount = 47, -- 购买归属次数
	cCrossBossCmd_DarkhallBossTips = 48, -- boss提醒数据
	
	cCrossBossCmd_ReqZhuzaiBossInfo = 61, -- 请求主宰BOSS信息
	cCrossBossCmd_RequestZhuzaiEnter = 62, -- 请求进入挑战主宰BOSS
	cCrossBossCmd_BuyZhuzaiCd = 63, -- 购买复活CD
	cCrossBossCmd_CancelZhuzaiBelong = 64, -- 取消boss归属
	cCrossBossCmd_BuyZhuzaiBelongCount = 67, -- 购买归属次数
	cCrossBossCmd_ZhuzaiBossTips = 68, -- boss提醒数据

	cCrossBossCmd_ReqEliteShowInfo = 51,
	...
	cAuctionCmd_ShowOwners = 8, -- 查看拍卖品受益人
	...
	sAuctionCmd_Limit = 7,
	sAuctionCmd_ShowOwners = 8, -- 查看拍卖品受益人
	...
	-- DailyRedPacketCMD -- 每日红包子协议
	 
	cDailyRedPacketInfo = 1, -- 每日红包信息
	cDailyCommonRedPacket = 2, -- 领取每日普通红包信息
	cDailyExtraRedPacket = 3, -- 领取每日普通红包信息
	cDailyRedPacketRecord = 4, -- 红包记录

	sDailyRedPacketInfo = 1, -- 每日红包信息
	sDailyCommonRedPacket = 2, -- 每日普通红包
	sDailyExtraRedPacket = 3, -- 额外红包
	sDailyRedPacketRecord = 4, -- 红包记录
	

    -- DemonCircleCMD
     
    cDemonCircleCmd_ArrayeyeLvUp = 1, -- 阵眼升级
    cDemonCircleCmd_NutritionExpAdd = 2, -- 蕴养加经验
	cDemonCircleCmd_PotentialpointStudy = 3, -- 潜能点领悟
	cDemonCircleCmd_Huanhua = 5, -- 幻化
    sDemonCircleCmd_ArrayeyeInfo = 1, -- 阵眼信息
    sDemonCircleCmd_NutritionInfo = 2, -- 蕴养信息
    sDemonCircleCmd_PotentialpointInfo = 3, -- 潜能点信息
	sDemonCircleCmd_TezhiInfo = 4, -- 特质信息
	sDemonCircleCmd_Huanhua = 5, -- 幻化



	-- DominateEquipCmd
    cDominateEquipCmd_EquipChange = 1, -- 更换装备(包含穿上)
    cDominateEquipCmd_EquipCompound = 2, -- 装备合成
	cDominateEquipCmd_EquipLvUp = 3, -- 饰品升级
	cDominateEquipCmd_EquipPextraction = 4, -- 属性萃取
	cDominateEquipCmd_LingStoneCompound = 6, -- 灵坯合成

    sDominateEquipCmd_EquipSlotInfo = 1, -- 身上装备信息
    sDominateEquipCmd_EquipCompound = 2, -- 装备合成
	sDominateEquipCmd_EquipLvUp = 3, -- 饰品升级
	sDominateEquipCmd_EquipPextraction = 4, -- 属性萃取
	sDominateEquipCmd_EquipInfo = 5, -- 角色属性



	cForbiddenAreaCmd_BossInfo = 1, -- 请求boss信息
	cForbiddenAreaCmd_PersonalInfo = 2, -- 个人信息,剩余挑战次数,当前禁地值
	cForbiddenAreaCmd_Challenge = 3, -- 请求挑战
	cForbiddenAreaCmd_Resurgence = 4, -- 请求花钱复活
	cForbiddenAreaCmd_CancelBelong = 5 , -- 请求取消归属
	cForbiddenAreaCmd_BuyChallengeCount = 9 , -- 请求购买挑战次数

	sForbiddenAreaCmd_BossInfo = 1, -- BOSS信息
	sForbiddenAreaCmd_PersonalInfo = 2, -- 个人信息,剩余挑战次数,当前禁地值
	sForbiddenAreaCmd_ResurgenceInfo = 4, -- 复活信息
	sForbiddenAreaCmd_SingleBossInfo = 6, -- 单个BOSS信息更新
	sForbiddenAreaCmd_BossBelongReward = 7, -- boss归属奖励
	sForbiddenAreaCmd_BossShield = 8, -- boss护盾提示


	sPlayerReturnCmd_InviteInfo = 1, -- 邀请信息
	sPlayerReturnCmd_ReturnInfo = 2, -- 回归信息
	sPlayerReturnCmd_InviteCode = 3, -- 绑定邀请码反馈
	sPlayerReturnCmd_GetInvNumReward= 4, -- 获取邀请数量奖励反馈
	sPlayerReturnCmd_GetInvRechargeReward = 5, -- 领取邀请充值额度奖励
	sPlayerReturnCmd_GetRetLoginReward= 6, -- 领取回归登录天数奖励
	sPlayerReturnCmd_GetRetRechargeReward = 7, -- 领取回归充值额度奖励
	sPlayerReturnCmd_GetRetReward = 8, -- 领取回归奖励

	cPlayerReturnCmd_InviteInfo = 1, -- 邀请信息
	cPlayerReturnCmd_ReturnInfo = 2, -- 回归信息
	cPlayerReturnCmd_InviteCode = 3, -- 绑定邀请码
	cPlayerReturnCmd_GetInvNumReward= 4, -- 获取邀请数量奖励
	cPlayerReturnCmd_GetInvRechargeReward = 5, -- 领取邀请充值额度奖励
	cPlayerReturnCmd_GetRetLoginReward= 6, -- 领取回归登录天数奖励
	cPlayerReturnCmd_GetRetRechargeReward= 7, -- 领取回归充值额度奖励
	cPlayerReturnCmd_GetRetReward = 8, -- 领取回归奖励
}
