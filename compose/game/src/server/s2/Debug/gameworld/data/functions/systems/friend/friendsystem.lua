...
local function sChat(actor, pack)
	...
	if aData and ChatConstConfig.siliaopaygoldnum then
		if aData.recharge < ChatConstConfig.siliaopaygoldnum then
			local tips = string.format( Lang.ScriptTips.chat001, ChatConstConfig.siliaopaygoldnum )
	...
	--记录私人聊天监控
	chat.addChatMonitorFriend(actor,actorBId,content)
end
