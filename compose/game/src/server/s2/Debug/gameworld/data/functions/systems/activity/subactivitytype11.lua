...
--下发数据
local function writeRecord(npack, record, conf, id, actor) -- id:activeid
...
local function onNewDay(id, conf) -- conf:ActivityType11_1Config
...
gmHandlers.addOneDay = function(actor, args)
    local id = 120
    updateTask(actor, 100, 0, 1)
end
