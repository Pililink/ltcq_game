...
local function openServerBoss()
	if not System.isCommSrv() then print("openServerBoss error 1") return end
	if false == crossbosssystem.checkCanOpen() then print("openServerBoss error 2") return end
	if crossbosssystem.isOpenCrossBoss() then print("openServerBoss error 3") return end
...
function crossBossOpen(curTime, flag)
	...
	-- 开启战斗服boss
	if System.isCommSrv() then print("crossBossOpen error 1") return end
