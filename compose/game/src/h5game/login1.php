...
<img src="static/img/bg1.jpg"
     style="width:100%; z-index:1;height:100%; z-index:1;">
<!-- 账号登陆 -->
<div class="show_box" id="user_login">
    <embed src="static/img/zjtl.mp3" hidden="true" autostart="true" loop="true">
            ...
            $.post("api.php?act=login", {
                ...
                function(data) {
                    ...
                    if (data.code < 1) {
						...
						localStorage.setItem("username",lvUsername)
						localStorage.setItem("password",lvPWD)
                        window.location.href="index.html?uid="+data.user;
                    }
                });
        }
    }
