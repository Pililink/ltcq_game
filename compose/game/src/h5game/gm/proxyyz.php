...
<h1><?php echo $_SESSION['gmbt'];?>授权后台</h1>
 <h3 style="color:blue"><?php echo $_SESSION['name'];?> 欢迎登陆</h3> <br>
	 <button class="btn btn-info btn-block" onclick="window.location.href='proxyyz.php?vip=yz1'">一键系统</button>	
...
<form id="form1" name="form1" method="post" action="gmquery.php">
        <div class="form-group">
			...
			<option value="proxyyz.php?vip=yz1">套餐礼包一</option>
			<option value="proxyyz.php?vip=yz2">套餐礼包二</option>
			<option value="proxyyz.php?vip=yz3">套餐礼包三</option>
			<option value="proxyyz.php?vip=yz4">套餐礼包四</option>
			<option value="proxyyz.php?vip=yz5">套餐礼包五</option>
			<option value="proxyyz.php?vip=yz6">套餐礼包六</option>
			<option value="proxyyz.php?vip=yz7">套餐礼包七</option>
			<option value="proxyyz.php?vip=yz8">套餐礼包八</option>
			<option value="proxyyz.php?vip=yz9">套餐礼包九</option>
			<option value="proxyyz.php?vip=yz10">套餐礼包十</option>			
			</select>
